...
<body>
	<form action="course/saveCourse.do" name="courseForm" id="courseForm"
		method="post">
		<div id="zhongxin" style="padding: 90px">
			...
			<div>
				<label>课程名</label><input type="text" name="courseName"
					id="courseName" placeholder="如:大学英语" />
			</div>
			<div>
			...
			<div>
				<label>学时</label><input type="text" name="period" placeholder="如:48" />
			</div>
			<div>
