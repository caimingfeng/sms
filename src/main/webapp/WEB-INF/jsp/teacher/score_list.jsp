...
<body>
	<div class="row-fluid">
		...
		<div class="table-header">教学班列表</div>
		<div id="table_report_wrapper" class="dataTables_wrapper" role="grid">
			<form action="score/toScoreList.do" method="post" name="classForm"
				id="classForm">
				<table>
					<tr>
									...
									<tr>
										...
										<td >
											<div class='hidden-phone visible-desktop btn-group center'>
												<a class='btn btn-mini btn-success' title="查看学生成绩"
													onclick="scoreQc('${cm.coursesMessageId}');"><i
													class='icon-edit'></i></a>
											</div>
										</td>
	...
	<script type="text/javascript">
		...
		//开班详细信息
		function scoreQc(coursesMessageId){
			 top.jzts();
			 var diag = new top.Dialog();
			 //alert(currentPage);
			 diag.Drag=true;
			 diag.Title ="学生成绩";
			 diag.URL = '<%=basePath%>score/toScoreQc.do?coursesMessageId='+coursesMessageId;
